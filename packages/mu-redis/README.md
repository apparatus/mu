...
The official Redis transport driver for mu
...
`mu-redis` is a Redis transport driver for `mu`, it allows for message dispatching across the Redis PubSub system.
...
[david-url]: https://david-dm.org/apparatus/mu?path=packages/mu-redis
